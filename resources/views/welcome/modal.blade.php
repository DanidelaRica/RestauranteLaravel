                        ...
                        <div class="form-group col">
                            ...
                            <select name="table" id="table" class="form-control">
                                @foreach($tables as $table)
                                    <option value="{{ $table->id }}">Mesa de {{ $table->seats }} asientos</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col">
                        ...
                        <div class="form-group col">
                            ...
                            <select name="menu" id="menu" class="form-control">
                                @foreach($menus as $menu)
                                    <option value="{{ $menu->id }}">{{ $menu->name }} - {{ $menu->prize }}€</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="form-group col">
                                ...
                                <select name="num_card" id="num_card" class="form-control">
                                    @foreach($credit_cards as $card)
                                        <option value="{{ $card->num_card }}">{{ $card->num_card }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
