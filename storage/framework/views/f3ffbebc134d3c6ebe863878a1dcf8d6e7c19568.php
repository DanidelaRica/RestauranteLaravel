                ...
                <form class="form-core" id="create-booking-form" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <input type="number" id="num_people" name="num_people" class="form-control" required="required" />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col">
                    ...
                    <?php else: ?>
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input type="text" id="credit_card" name="credit_card" class="form-control" required="required" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="expire_month">Mes expiración</label>
                                <input type="text" id="expire_month" name="expire_month" class="form-control" required="required" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="expire_year">Año expiración</label>
                                <input type="text" id="expire_year" name="expire_year" class="form-control" required="required" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col">
...
<?php /**PATH C:\wamp64\www\restaurantee\resources\views/welcome/modal.blade.php ENDPATH**/ ?>