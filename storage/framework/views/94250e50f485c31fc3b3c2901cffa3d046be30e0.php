    ...
    <div class="container my-5 py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-3 text-white animated slideInLeft">Disfrute De<br>Nuestros platos</h1>
                ...
                <a href="<?php echo e(route('welcome.booking')); ?>" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Reserva</a>
            </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restauranteee\resources\views/welcome/index.blade.php ENDPATH**/ ?>